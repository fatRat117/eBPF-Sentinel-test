...
type networkMapSpecs struct {
	...
	IpWhitelistEnabled   *ebpf.MapSpec `ebpf:"ip_whitelist_enabled"`
	NetEvents            *ebpf.MapSpec `ebpf:"net_events"`
	NetMonitoringEnabled *ebpf.MapSpec `ebpf:"net_monitoring_enabled"`
	PortWhitelist        *ebpf.MapSpec `ebpf:"port_whitelist"`
	PortWhitelistEnabled *ebpf.MapSpec `ebpf:"port_whitelist_enabled"`
...
func (m *networkMaps) Close() error {
	return _NetworkClose(
		...
		m.NetEvents,
		m.NetMonitoringEnabled,
		m.PortWhitelist,
		m.PortWhitelistEnabled,
		m.SampleCounter,
	)
}
